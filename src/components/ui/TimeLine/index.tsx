...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div ref={ref} className="relative h-full max-w-7xl mx-auto pb-10">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex h-full justify-start items-center pt-10 md:pt-15 md:gap-25"
          >
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3 className="md:hidden block text-xl mb-4 text-left font-bold text-gray-800">
                {item.title}
              </h3>
              {item.content}{" "}
            </div>
