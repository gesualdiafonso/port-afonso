...
export default function ProjectDetails ({ title, image, description, list, tech, link, closeModal }: ProjectDetailsProps){
    ...
    return(
        <div className="fixed bg-gray-900/50 inset-0 z-50 flex items-center justify-center w-full h-full overflow-hidden backdrop-blur-sm">
            <motion.div
            ...
            >
                ...
                <Image src={image} alt={title} width={800} height={400} className="w-full max-h-[600px] rounded-t-2xl object-cover" />
                <div className="px-10 py-5">
                    ...
                    <a
                        ...
                        className="mt-5 group relative inline-block cursor-pointer overflow-hidden rounded-full border 
                                    border-gray-200 bg-white px-5 py-2 text-center font-medium text-gray-900 shadow-sm 
                                    transition-all duration-300 hover:shadow-md dark:border-gray-800 dark:bg-gray-950 
                                    dark:text-white dark:hover:border-gray-700"
                        >
                        {/* FRONT TEXT + DOT */}
                        <div className="flex items-center gap-3">
                            <div className="h-2 w-2 rounded-full bg-gray-900 transition-all duration-300 
                                            group-hover:scale-[100.8] dark:bg-white"></div>
                        ...
                        {/* HOVER LAYER (CORRECT POSITION!) */}
                        <div
                            className="absolute top-0 left-0 z-10 flex h-full w-full translate-x-12 items-center 
